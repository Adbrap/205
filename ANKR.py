...
#
                ...
                if (C - B) < (C - D) and (C - B) < (E - D) and (E - F) < (E - D) and (E - F) < (C - D) and B > D and F > D and B < C and F < E and A >= mirande2['c'].iloc[0] and verif == 0:
                        ...
                        if I[1] > B and J[1] > F and moyenne_epaule1 <= moyenne_tete / 2 and moyenne_epaule2 <= moyenne_tete / 2 and moyenne_epaule1 >= moyenne_tete / 4 and moyenne_epaule2 >= moyenne_tete / 4 and df['c'].values[-2] <= J[1] + (moyenne_tete) / 4 and df['c'].values[-2] >= J[1]  and df['c'].values[-3] <= J[1] + (moyenne_tete) / 4 and df['c'].values[-3] >= J[1]  and G >= J[1] and accept == True and local_max[-3] < local_min[-2] and local_max[-3] < local_min[-2] and local_max[-1] < local_min[-1]:
                                ...
                                plt.text(place_liveprice-1, G, "G", ha='left', style='normal', size=10.5, color='red',wrap=True)
                                ...
                                plt.scatter(len(df['c'])-2, df['c'].values[-2], color='blue',label='liveprice')
                                plt.scatter(len(df['c']) - 3, df['c'].values[-3], color='orange', label='cloture')
